@extends('admin.layouts.admin_temp')
  ...
  <div class="container my-5">
    <div class="mx-2">
      ...
      <form action="{{ route('user.store') }}" method="POST" class="px-md-5">
        ...
        <div class="form-group mb-3 row">
          ...
          <div class="col-md-5">
            <input type="text" placeholder="First Name" class="form-control @error('name') is-invalid @enderror" name="name" value="{{ old('name') }}" required autocomplete="name"  />
            @error('name')
        ...
        <div class="form-group mb-3 row">
          ...
          <div class="col-md-10">
            <input type="email" placeholder="e.g. Jhon@example.com" class="form-control @error('email') is-invalid @enderror" name="email" value="{{ old('email') }}" required autocomplete="email" />
            @error('email')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
    ...
    <div class="col-md-10">
        ...
        <input type="checkbox" class="form-check-input" style="padding: 0.7rem;" @checked(old('active')) value="1" name="active" autocomplete="active" />
